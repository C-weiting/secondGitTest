<template>
  <div class="goods">
    ...
    <div class="footer">
      <shop-cart :minPrice="seller.minPrice" :deliveryPrice="seller.deliveryPrice" :selectedFood="selectedFood"></shop-cart>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    selectMenu(index, ev) {
      ...
      let el = this.$refs.foodWrapper.getElementsByClassName('food-list-hook')[
        index
      ]
